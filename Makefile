...
OBJS=fspc.o scanner.o parser.o symbols_table.o lts.o context.o global.o utils.o
...
parser.o: context.hpp symbols_table.hpp parser.cpp lts.hpp utils.hpp scanner.hpp global.hpp
